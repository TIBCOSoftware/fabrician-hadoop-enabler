...
<table>
  ...
  <tr>
    ...
    <td>A single-host Hadoop <i>Pseudo Cluster</i> as implemented by the start-all.sh script in the Hadoop install.</td>
  </tr>
</table>
...
<ul>
<li>Automated Re-Balancing - When one or new Datanodes are added, the Balancer will automatically be invoked to distribute data to the new node(s)</li>
...
<table>
  ...
  <tr>
    ...
    <td>[Hadoop Install]/conf/hadoop_enabler_RACKAWARENESS.cfg</td>
  </tr>
  <tr>
